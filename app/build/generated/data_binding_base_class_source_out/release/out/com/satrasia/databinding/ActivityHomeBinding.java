...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  private ActivityHomeBinding(@NonNull SwipeRefreshLayout rootView, @NonNull TextView etName,
      @NonNull MapView map, @NonNull LinearLayout mapContainer, @NonNull BottomNavigationView nav,
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHomeBinding((SwipeRefreshLayout) rootView, etName, map, mapContainer, nav,
          navhost, newButtonTask, swipeRefreshLayout, toDoListRecyclerView);
    }
