...
public final class ActivityAccountManagerBinding implements ViewBinding {
  ...
  private ActivityAccountManagerBinding(@NonNull LinearLayout rootView,
      @NonNull CircularImageView CircularImageView, @NonNull ImageButton btnBack,
      @NonNull Button btnChangePassword, @NonNull Button btnDeleteAccount,
      @NonNull Button btnDeleteProfile, @NonNull Button btnSaveEmail, @NonNull Button btnSaveName,
      @NonNull Button btnSavePhoneNumber, @NonNull Button btnUpdateProfile,
      @NonNull TextView etEmail, @NonNull TextView etName, @NonNull TextView etNoTelp,
      @NonNull EditText updateEmail, @NonNull EditText updateName,
  ...
  public static ActivityAccountManagerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAccountManagerBinding((LinearLayout) rootView, CircularImageView, btnBack,
          btnChangePassword, btnDeleteAccount, btnDeleteProfile, btnSaveEmail, btnSaveName,
          btnSavePhoneNumber, btnUpdateProfile, etEmail, etName, etNoTelp, updateEmail, updateName,
          updatePhoneNumber);
    }
